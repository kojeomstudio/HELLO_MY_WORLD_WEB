...
public class GameHub : Hub<IGameClient>
{
    ...
    private async Task SendBlockDefinitions()
    {
        ...
        var dto = definitions.Select(kvp => new
        {
            ...
            healPerSecond = kvp.Value.HealPerSecond,
            ...
            bouncy = kvp.Value.Bouncy,
            slippery = kvp.Value.Slippery,
            moveResistance = kvp.Value.MoveResistance,
            postEffectColor = kvp.Value.PostEffectColor,
            drowning = kvp.Value.Drowning,
            falling = kvp.Value.Falling,
            waving = kvp.Value.Waving,
            noJump = kvp.Value.NoJump,
            liquidNoSwim = kvp.Value.LiquidNoSwim,
            buildableTo = kvp.Value.BuildableTo,
            attachedNode = kvp.Value.AttachedNode,
            fallDamageAddPercent = kvp.Value.FallDamageAddPercent,
            damageGroup = kvp.Value.DamageGroup,
            soundGroup = kvp.Value.SoundGroup,
            groups = kvp.Value.Groups,
            liquidRange = kvp.Value.LiquidRange,
            liquidViscosity = kvp.Value.LiquidViscosity,
            liquidRenewable = kvp.Value.LiquidRenewable,
