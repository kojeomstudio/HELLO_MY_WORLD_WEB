...
public class BlockDefinitionManager
{
    ...
    private void LoadDefaults()
    {
        _definitions = new Dictionary<ushort, BlockDefinition>
        {
            ...
            [(ushort)BlockType.Torch] = new() { Id = 16, Name = "torch", Solid = false, Transparent = true, Color = "#FFD700", Light = 14, AttachedNode = true, Groups = new() { ["dig_immediate"] = 3 }, SoundGroup = "default" },
            [(ushort)BlockType.Ladder] = new() { Id = 17, Name = "ladder", Solid = false, Transparent = true, Color = "#8B4513", Climbable = true, Groups = new() { ["choppy"] = 2 }, AttachedNode = true, SoundGroup = "wood" },
            ...
            [(ushort)BlockType.SnowLayer] = new() { Id = 81, Name = "snow_layer", Solid = true, Transparent = true, Color = "#FFFAFA", Hardness = 0.2f, DrawType = "slab", Groups = new() { ["crumbly"] = 3, ["oddly_breakable_by_hand"] = 3 }, BuildableTo = true, SoundGroup = "snow" },
            ...
            [(ushort)BlockType.DeadBush] = new() { Id = 120, Name = "dead_bush", Solid = false, Transparent = true, Color = "#8B7355", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.TallGrass] = new() { Id = 121, Name = "tall_grass", Solid = false, Transparent = true, Color = "#4A8C3A", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.FlowerRed] = new() { Id = 122, Name = "flower_red", Solid = false, Transparent = true, Color = "#FF3333", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3, ["flower"] = 1 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.FlowerYellow] = new() { Id = 123, Name = "flower_yellow", Solid = false, Transparent = true, Color = "#FFFF33", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3, ["flower"] = 1 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.FlowerRose] = new() { Id = 124, Name = "flower_rose", Solid = false, Transparent = true, Color = "#CC0000", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3, ["flower"] = 1 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.FlowerTulip] = new() { Id = 125, Name = "flower_tulip", Solid = false, Transparent = true, Color = "#FF6699", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3, ["flower"] = 1 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.MushroomRedBlock] = new() { Id = 126, Name = "mushroom_red_block", Solid = false, Transparent = true, Color = "#CC2222", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.MushroomBrownBlock] = new() { Id = 127, Name = "mushroom_brown_block", Solid = false, Transparent = true, Color = "#8B6B4A", Hardness = 0.0f, DrawType = "plantlike", Groups = new() { ["dig_immediate"] = 3 }, Waving = 1, BuildableTo = true, SoundGroup = "grass" },
            ...
            [(ushort)BlockType.SoulTorch] = new() { Id = 141, Name = "soul_torch", Solid = false, Transparent = true, Color = "#6699FF", Light = 10, DrawType = "torch", Groups = new() { ["dig_immediate"] = 3 }, AttachedNode = true, SoundGroup = "default" },
            ...
            [(ushort)BlockType.Sign] = new() { Id = 161, Name = "sign", Solid = false, Transparent = true, Color = "#8B6914", Interactive = true, Hardness = 1.0f, AttachedNode = true, Groups = new() { ["choppy"] = 3, ["oddly_breakable_by_hand"] = 3 }, SoundGroup = "wood" },
            ...
            [(ushort)BlockType.RedstoneWire] = new() { Id = 164, Name = "redstone_wire", Solid = false, Transparent = true, Color = "#CC0000", Hardness = 0.0f, Groups = new() { ["dig_immediate"] = 3 }, AttachedNode = true, SoundGroup = "default" },
            [(ushort)BlockType.RedstoneTorch] = new() { Id = 165, Name = "redstone_torch", Solid = false, Transparent = true, Color = "#FF3300", Light = 7, Hardness = 0.0f, Groups = new() { ["dig_immediate"] = 3 }, AttachedNode = true, SoundGroup = "default" },
            [(ushort)BlockType.Lever] = new() { Id = 166, Name = "lever", Solid = false, Transparent = true, Color = "#6B6B6B", Interactive = true, Hardness = 0.5f, Groups = new() { ["dig_immediate"] = 3 }, AttachedNode = true, SoundGroup = "stone" },
            [(ushort)BlockType.Button] = new() { Id = 167, Name = "button", Solid = false, Transparent = true, Color = "#808080", Interactive = true, Hardness = 0.5f, Groups = new() { ["dig_immediate"] = 3 }, AttachedNode = true, SoundGroup = "stone" },
...
[(ushort)BlockType.Kelp] = new() { Id = 222, Name = "kelp", Solid = false, Transparent = true, Color = "#2A8A2A", Hardness = 0.0f, AttachedNode = true, Groups = new() { ["snappy"] = 3, ["dig_immediate"] = 3 }, SoundGroup = "grass" },
            [(ushort)BlockType.SeaGrass] = new() { Id = 223, Name = "sea_grass", Solid = false, Transparent = true, Color = "#2A7A3A", Hardness = 0.0f, Groups = new() { ["snappy"] = 3, ["dig_immediate"] = 3 }, BuildableTo = true, SoundGroup = "grass" },
            [(ushort)BlockType.SeaPickle] = new() { Id = 224, Name = "sea_pickle", Solid = false, Transparent = true, Color = "#80CC30", Light = 6, Hardness = 0.0f, AttachedNode = true, Groups = new() { ["dig_immediate"] = 3 }, SoundGroup = "grass" },
            ...
            [(ushort)BlockType.Vine] = new() { Id = 236, Name = "vine", Solid = false, Transparent = true, Color = "#2A6A2A", Hardness = 0.2f, DrawType = "plantlike", AttachedNode = true, BuildableTo = true, Climbable = true, Groups = new() { ["snappy"] = 2 }, Waving = 1, SoundGroup = "grass" },
            [(ushort)BlockType.RedstoneRepeater] = new() { Id = 237, Name = "redstone_repeater", Solid = true, Color = "#8B0000", Hardness = 0.5f, Interactive = true, Light = 7, Groups = new() { ["dig_immediate"] = 3 }, SoundGroup = "stone" },
            [(ushort)BlockType.RedstoneComparator] = new() { Id = 238, Name = "redstone_comparator", Solid = true, Color = "#7B6B4A", Hardness = 0.5f, Interactive = true, Groups = new() { ["dig_immediate"] = 3 }, SoundGroup = "stone" },
        };
    }
...
public class BlockDefinition
{
    ...
    public string? TextureName => Name switch
    {
        ...
        "vine" => "default_vine",
        "redstone_repeater" => "default_repeater",
        "redstone_comparator" => "default_comparator",
        _ => null
    };
}
