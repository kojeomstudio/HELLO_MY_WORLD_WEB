...
export class WieldItem {
    ...
    private createToolMesh(itemName: string): THREE.Mesh {
        ...
        else if (itemName.includes('mese')) { color = 0xFFFF00; handleColor = 0x5C3317; }
        else if (itemName.includes('blood')) { color = 0x880000; handleColor = 0x3D1C02; }
        else if (itemName.includes('fire')) { color = 0xFF6600; handleColor = 0x5C3317; }
        else if (itemName.includes('ice')) { color = 0x88CCFF; handleColor = 0x5C3317; }
        else if (itemName.includes('heal')) { color = 0x44FF44; handleColor = 0x5C3317; }
