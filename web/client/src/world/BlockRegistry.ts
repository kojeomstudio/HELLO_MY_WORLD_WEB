...
export class BlockRegistry {
    ...
    private loadDefaults(): void {
        const defaultBlocks: BlockDefinition[] = [
            ...
            { id: 15, name: 'lava', solid: false, transparent: true, color: '#FF4500', liquid: true, damage: 4, textureName: 'default_lava', waving: 3 },
            ...
            { id: 70, name: 'junglegrass', solid: false, transparent: true, color: '#00AA00', hardness: 0.0, groups: { dig_immediate: 3 }, soundGroup: 'grass', textureName: 'default_junglegrass', waving: 1 },
            ...
            { id: 72, name: 'jungle_leaves', solid: true, transparent: true, color: '#1A8C1A', hardness: 0.2, groups: { snappy: 3 }, soundGroup: 'leaves', textureName: 'default_jungleleaves', waving: 2 },
            ...
            { id: 74, name: 'pine_needles', solid: true, transparent: true, color: '#1A5C1A', hardness: 0.2, groups: { snappy: 3 }, soundGroup: 'leaves', textureName: 'default_pine_needles', waving: 2 },
            ...
            { id: 98, name: 'huge_mushroom_red', solid: true, transparent: false, color: '#B22222', hardness: 0.3, groups: { choppy: 3 }, soundGroup: 'wood' },
            ...
            { id: 120, name: 'dead_bush', solid: false, transparent: true, color: '#8B7355', hardness: 0, groups: { dig_immediate: 3 }, soundGroup: 'grass', waving: 1 },
            { id: 121, name: 'tall_grass', solid: false, transparent: true, color: '#4A8C3A', hardness: 0, groups: { dig_immediate: 3 }, soundGroup: 'grass', waving: 1 },
            { id: 122, name: 'flower_red', solid: false, transparent: true, color: '#FF3333', hardness: 0, groups: { dig_immediate: 3, flower: 1 }, soundGroup: 'grass', waving: 1 },
            { id: 123, name: 'flower_yellow', solid: false, transparent: true, color: '#FFFF33', hardness: 0, groups: { dig_immediate: 3, flower: 1 }, soundGroup: 'grass', waving: 1 },
            { id: 124, name: 'flower_rose', solid: false, transparent: true, color: '#CC0000', hardness: 0, groups: { dig_immediate: 3, flower: 1 }, soundGroup: 'grass', waving: 1 },
            { id: 125, name: 'flower_tulip', solid: false, transparent: true, color: '#FF6699', hardness: 0, groups: { dig_immediate: 3, flower: 1 }, soundGroup: 'grass', waving: 1 },
            { id: 126, name: 'mushroom_red_block', solid: false, transparent: true, color: '#CC2222', hardness: 0, groups: { dig_immediate: 3 }, soundGroup: 'grass', waving: 1 },
            { id: 127, name: 'mushroom_brown_block', solid: false, transparent: true, color: '#8B6B4A', hardness: 0, groups: { dig_immediate: 3 }, soundGroup: 'grass', waving: 1 },
            ...
            { id: 237, name: 'redstone_repeater', solid: true, transparent: false, color: '#8B0000', hardness: 0.5, interactive: true, light: 7, groups: { dig_immediate: 3 }, soundGroup: 'stone', textureName: 'default_repeater' },
            { id: 238, name: 'redstone_comparator', solid: true, transparent: false, color: '#7B6B4A', hardness: 0.5, interactive: true, groups: { dig_immediate: 3 }, soundGroup: 'stone', textureName: 'default_comparator' }
        ];
